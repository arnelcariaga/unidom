...
<body class="font-muli theme-cyan ">
					...
					<div class="d-flex justify-content-between align-items-center ">
						<div class="header-action">
							...
							<ol class="breadcrumb page-breadcrumb">
								<li class="breadcrumb-item"><a href="module.php">Entidades</a></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(document).on('click', '.dt-edit-entity', function(evt){
				$this = $(this);
				var dtRow = $this.parents('tr');

				$.ajax({
					url: 'controller/edit_entity_ui.php', 
					type: 'POST',
					data: 'gENTI='+dtRow.attr('id'),
					success: function (response) {
						$('.modal-body-edit-entity').html(response);
					}
				});
			...
			$(document).on('click', '.dt-remove-entity', function(evt){
				$this = $(this);
				var dtRow = $this.parents('tr');

				$.ajax({
					url: 'controller/remove_entity_ui.php.', 
					type: 'POST',
					data: 'gENTI='+dtRow.attr('id'),
					success: function (response) {
						$('.modal-body-remove-entity').html(response);
					}
				});
