...
<head>
	...
	<?php echo $subject_active = 'active'; ?>
</head>
<body class="font-muli theme-cyan ">
					...
					<div class="d-flex justify-content-between align-items-center ">
						<div class="header-action">
							...
							<ol class="breadcrumb page-breadcrumb">
								<li class="breadcrumb-item"><a href="module.php">Materias</a></li>
							</ol>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(document).on('click', '.dt-edit-subject', function(evt){
				$this = $(this);
				var dtRow = $this.parents('tr');

				$.ajax({
					url: 'controller/edit_subject_ui.php', 
					type: 'POST',
					data: 'gSBJI='+dtRow.attr('id'),
					success: function (response) {
						$('.modal-body-edit-subject').html(response);
					}
				});
			...
			$(document).on('click', '.dt-remove-subject', function(evt){
				$this = $(this);
				var dtRow = $this.parents('tr');

				$.ajax({
					url: 'controller/remove_subject_ui.php.', 
					type: 'POST',
					data: 'gSBJI='+dtRow.attr('id'),
					success: function (response) {
						$('.modal-body-remove-subject').html(response);
					}
				});

				$('#modalRemoveSubject').modal('show');
			});
